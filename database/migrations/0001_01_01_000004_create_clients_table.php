...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('clients', function (Blueprint $table) {
            ...
            $table->string('ap_phone', 20)->nullable();
            $table->string('ap_phone_extension', 20)->nullable();
            $table->string('ap_email')->nullable();
            $table->string('ar_phone', 20)->nullable();
            $table->string('ar_phone_extension', 20)->nullable();
            $table->string('ar_email')->nullable();
            $table->string('general_phone', 20)->nullable();
            $table->string('general_phone_extension', 20)->nullable();
            $table->string('general_email')->nullable();
            $table->string('ivr_phone', 20)->nullable();
            $table->string('ivr_phone_extension', 20)->nullable();
            $table->string('ivr_email')->nullable();
            $table->string('vendor_phone', 20)->nullable();
            $table->string('vendor_phone_extension', 20)->nullable();
        ...
        Schema::create('client_portal_logins', function (Blueprint $table) {
            $table->id();
            $table->foreignId('user_id')->constrained('users')->cascadeOnDelete()->cascadeOnUpdate();
            $table->foreignId('client_portal_id')->constrained('client_portals')->cascadeOnDelete()->cascadeOnUpdate();
            $table->string('name', 50);
            $table->string('description', 500)->nullable();
        ...
        Schema::create('client_locations', function (Blueprint $table) {
            ...
            $table->string('pre_direction', 50)->nullable();
