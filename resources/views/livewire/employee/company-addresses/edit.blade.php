...
new class extends Component {
    ...
    public function mount(): void
    {
        ...
        $this->title = $this->companyAddress->title;
        $this->building_number = $this->companyAddress->building_number;
        $this->pre_direction = $this->companyAddress->pre_direction;
        $this->street_name = $this->companyAddress->street_name;
        $this->street_type = $this->companyAddress->street_type;
        $this->post_direction = $this->companyAddress->post_direction;
        $this->unit_type = $this->companyAddress->unit_type;
        $this->unit = $this->companyAddress->unit;
        $this->po_box = $this->companyAddress->po_box;
        $this->city = $this->companyAddress->city;
        $this->state = $this->companyAddress->state;
        $this->zip = $this->companyAddress->zip;
    }
    ...
    public function update(): void
    {
        ...
        if ($this->companyAddress->update($validated))
        {
            $this->js('console.log("Updated")');
            $this->dispatch('company-address-updated');
        }
    }

    public function cancel(): void
    {
        $this->dispatch('company-address-edit-canceled');
    }
    ...
    <form wire:submit="update" novalidate autocomplete="off">
        <div class="card custom-card">
            ...
            <div class="card-footer">
                <x-submit-cancel id="company-address-edit" />
            </div>
        </div>
    </form>
</div>
