...
new class extends Component {
    ...
    #[Validate('required|string|min:2|max:50|unique:companies')]
    public string $name = '';
    ...
    public function store()
    {
        ...
        if ($company = auth()->user()->company()->create($validated)) {
            ...
            $this->abbreviation = '';
            $this->iwo_prefix = '';
            $this->iwo_max_length = null;
            $this->iwo_postfix_increment = null;
            $this->photo = null;
            $this->logo_path = null;
            $this->fein = '';
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="form-grid">
                    ...
                    <div class="cols-2">
                        <x-input id="iwo-max-length" model="iwo_max_length"
