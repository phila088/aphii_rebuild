<div id="switcher-canvas" class="hs-overlay hs-overlay-open:translate-x-0 hidden translate-x-full fixed top-0 end-0 transition-all duration-300 transform h-full max-w-xs w-full z-[1000] bg-white border-s dark:bg-gray-800 dark:border-gray-700 offcanvas offcanvas-end" tabindex="-1">
