<x-app-layout>
    ...
    @section ('breadcrumbs')
        <x-breadcrumb-container>
            ...
            <x-breadcrumb-item-active label="Companies" />
        </x-breadcrumb-container>
    @endsection
    @section('content')
        <div class="flex flex-col w-full">
            <div class="card custom-card">
                <div class="card-header flex justify-between">
                    ...
                    <div>
                        <a href="{{ route('employee.companies.index') }}" class="btn-red btn-sm rounded-md">Cancel</a>
                    </div>
                </div>
            </div>
            <livewire:employee.companies.create />
        </div>
    @endsection
    @section ('scripts')
        <script>
